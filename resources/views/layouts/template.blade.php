                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-footer-widget instafeed">
                            ...
                            <ul class="list_style instafeed d-flex flex-wrap">
                                <li><img src="{{ asset('template/image/instagram/Image-01') }}" alt=""></li>
                                <li><img src="{{ asset('template/image/instagram/Image-02') }}" alt=""></li>
                                <li><img src="{{ asset('template/image/instagram/Image-03') }}" alt=""></li>
                                <li><img src="{{ asset('template/image/instagram/Image-04') }}" alt=""></li>
                                <li><img src="{{ asset('template/image/instagram/Image-05') }}" alt=""></li>
                                <li><img src="{{ asset('template/image/instagram/Image-06') }}" alt=""></li>
                                <li><img src="{{ asset('template/image/instagram/Image-07') }}" alt=""></li>
                                <li><img src="{{ asset('template/image/instagram/Image-08') }}" alt=""></li>
                            </ul>
                        </div>
                    </div>
                </div>
